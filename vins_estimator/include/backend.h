...
#include "backend/imu_factor.h"
#include "backend/pose_local_parameterization.h"
#include "backend/projection_factor.h"
#include "backend/projection_td_factor.h"
#include "backend/marginalization_factor.h"
...
class Backend
{
  public:
    ...
    void getInverseDepthInRight(Estimator *estimator,const double para_Feature[][SIZE_FEATURE]);
